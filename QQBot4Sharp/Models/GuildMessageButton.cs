...
namespace QQBot.NET.Models
{
    ...
    /// 消息按钮
    /// </summary>
    public class GuildMessageButton
    {
        /// <summary>
        ...
        public GuildMessageButtonStyle Style { get; set; }

        /// <summary>
        /// （必填）按钮行为
        /// </summary>
        [JsonProperty("action.type")]
        public GuildMessageButtonAction Action { get; set; }

        /// <summary>
        /// （必填）操作权限
        /// </summary>
        [JsonProperty("action.permisson.type")]
        public GuildMessageButtonPermission Permission { get; set; }
