...
namespace QQBot.NET.Models
{
    ...
    /// </summary>
    public class GuildMessageReq
    {
        /// <summary>
        /// （选填）消息内容，文本内容，支持<a href="https://bot.q.qq.com/wiki/develop/api-v2/server-inter/message/message_format.html">内嵌格式</a><br/>可以使用<see cref="GuildMessageBuilder"/>来构建消息
        /// </summary>
