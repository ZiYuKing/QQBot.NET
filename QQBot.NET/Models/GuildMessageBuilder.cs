...
namespace QQBot.NET.Models
{
    ...
    /// 消息构造器
    /// </summary>
    public class GuildMessageBuilder
    {
        /// <summary>
        /// 字符串构造器
        /// </summary>
        ...
        public GuildMessageBuilder Raw(string data)
        {
            _sb.Append(data);
            return this;
        }
        ...
        /// <param name="data">内容</param>
        /// <returns>消息构造器</returns>
        public GuildMessageBuilder Text(string data)
        {
        ...
        /// <returns>消息构造器</returns>
        public GuildMessageBuilder At(string id)
        {
            _sb.Append("<@");
            _sb.Append(id);
            _sb.Append(">");
        ...
        /// </summary>
        /// <returns>消息构造器</returns>
        public GuildMessageBuilder AtAll()
        {
            _sb.Append("@everyone");
            return this;
        }
        ...
        /// <returns>消息构造器</returns>
        public GuildMessageBuilder Channel(string id)
        {
            _sb.Append("<#");
            _sb.Append(id);
            _sb.Append(">");
        ...
        /// <returns>消息构造器</returns>
        public GuildMessageBuilder Emoji(string id)
        {
            _sb.Append("<emoji:");
            _sb.Append(id);
            _sb.Append(">");
